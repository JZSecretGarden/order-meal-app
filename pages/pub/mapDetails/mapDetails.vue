<template>
	<view class="example">
		...
		<view style="margin-top: 20upx;" @click="doSearch()"><button size="default"
				style="background-color: #3190e8;color: #ffffff;width: 650upx;">提交</button></view>
		<view style="margin-top: 40upx;width: 600upx;">
			<view v-for="(item, index) in dataList" :key="item" style="border-top: 1upx solid #e4e4e4;padding: 12upx 0;"
