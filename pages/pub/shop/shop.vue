							...
							<view class="evaluate-article">
								...
								<view class="evaluate-article-item" v-for="item in evaluateContent">
									...
									<view class="evaluate-image-box">
										<image :src="'https://elm.cangdu.org/img/'+item.avatar" mode="aspectFill"></image>
									</view>
									<!-- 内容包 -->
									<view class="content-box">
										...
										<view class="commodity-image-row">
											<image v-for="commodity in item.item_ratings" :src="'https://elm.cangdu.org/img/'+commodity.image_hash" mode="aspectFill"></image>
										</view>
