...
// 获取用户信息v1/user
export const $fetch_v1_user = (params)=>req('v1/user','Get',params)
// 退出登录https://elm.cangdu.org/v2/signout
export const $fetch_v2_signout = ()=>req('v2/signout','Get')
// 可用红包promotion/v2/users/:user_id/hongbaos
export const $fetch_bos_v2_users_hongbaos = (user_id,params)=>req('promotion/v2/users/'+user_id+'/hongbaos','Get',params)